...
export class AppSettings implements OnInit {
  ...
  async presentAlert() {
    ...
    (hereinafter, "us", "we", or "NavConU Application"). We respect your privacy and are committed
    to protecting personally identifiable information you may provide us through the Website. 
